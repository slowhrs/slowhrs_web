        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col gap-6">
            <div className="mb-2 w-[120px] md:w-[150px] mix-blend-screen opacity-90">
              <Image src="/assets/logos/logo_main.png" alt="SLOWHRS Logo" width={200} height={45} className="w-full h-auto" />
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <nav className="flex flex-col gap-3">
              <Link href="#footer" className="font-mono text-[10px] tracking-[0.1em] text-brand-ink/60 hover:text-brand-ink transition-colors uppercase w-fit">Instagram</Link>
              <Link href="#footer" className="font-mono text-[10px] tracking-[0.1em] text-brand-ink/60 hover:text-brand-ink transition-colors uppercase w-fit">TikTok</Link>
              <Link href="#footer" className="font-mono text-[10px] tracking-[0.1em] text-brand-ink/60 hover:text-brand-ink transition-colors uppercase w-fit">YouTube</Link>
