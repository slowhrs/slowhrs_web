...
export const drops: Drop[] = [
  {
    ...
    blurb: 'indigo black. heavy waxed cotton. runs narrow. members got the early window.',
  ...
  },
  {
    ...
    blurb: 'off-white. asphalt. red trim. cut boxy on purpose.',
  ...
  },
  {
    ...
    blurb: 'heavy cotton. print front and back. pulled from the spring show archive.',
  ...
  },
  {
    ...
    blurb: 'one of one. hand-distressed. numbered on the tag.',
    image: '/assets/events/destroy_lonely.mp4',
    hoverVideo: '/assets/drops/christmas_drop.mp4',
    status: '1of1',
  },
  {
    id: 'DR-005',
    ...
    blurb: 'cropped at the knee. distressed hem. red tag on the back pocket.',
  ...
  },
  {
    ...
    blurb: 'sold. never restocked. archive record only.',
    image: '/assets/drops/fast_life_reel.mp4',
    hoverVideo: null,
    status: 'gone',
  },
