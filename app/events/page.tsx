...
const FALLBACK_EVENTS: EventData[] = [
  {
    ...
    blurb: "luxury safari editorial. photo shoot + content pre game for models, creatives, and good energy. come camera ready.",
  ...
  },
  {
    ...
    location: "Los Angeles",
    blurb: "we made it to the next year. here's how.",
    partiful_url: null,
  ...
  },
  {
    ...
    blurb: "the clothing reel. on hollywood. fall drop.",
    partiful_url: null,
  ...
  },
  {
    ...
    location: "Los Angeles",
    blurb: "the runway. one night only. members in the front row.",
    partiful_url: null,
