...
export default function MembershipPage() {
  ...
  return (
    <main className="min-h-screen bg-bg pt-[52px]">
      ...
      <div
        className="ambient-glow ambient-glow--rose"
      ...
      <div className="relative z-10 max-w-[720px] mx-auto px-6 pt-20 md:pt-28 pb-24">
        ...
        <div className="mt-16 relative">
          {TIERS.map((tier, i) => (
            <ScrollReveal key={tier.num} delay={i * 100}>
              <div
                ...
                style={
                  tier.accent
                    ? { borderLeftColor: "var(--color-rose)", animation: "ctaBreatheRose 8s ease-in-out infinite" }
                    : undefined
                }
              >
            ...
            <ScrollReveal delay={500}>
              ...
              >
                <input
                  ...
                  required
                  className="bg-transparent border-b border-border-2 py-3 font-mono text-[13px] text-ink placeholder:text-ink-faint form-glow-rose transition-colors"
                />
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="bg-transparent border-b border-border-2 py-3 font-mono text-[13px] text-ink placeholder:text-ink-faint form-glow-rose transition-colors resize-none"
                />
